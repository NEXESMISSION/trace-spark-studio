...
interface FirebaseGoogleSignInProps {
  onSuccess?: () => void;
}

const FirebaseGoogleSignIn: React.FC<FirebaseGoogleSignInProps> = ({ onSuccess }) => {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      // If popup fails (often due to popup blockers), try redirect
      if (error.code === 'auth/popup-blocked' || error.code === 'auth/popup-closed-by-user') {
        try {
          // Redirect flow will not return here - it will redirect to the page
